...
const questionAnsweredFunc = function (is_correct) {
    if (is_correct) {
        totalCorrect.value++;
    }
...
<template>
    <header>
        <nav class="navbar">
            <h1 class="heading">Quiz Channel</h1>
        </nav>
    </header>
    <div class="ctr">
        <transition name="fade" mode="out-in">
            <questions v-if="questionsAnswered < questions.length" :questions="questions"
                :questionsAnswered="questionsAnswered" @question-answered="questionAnsweredFunc" />
